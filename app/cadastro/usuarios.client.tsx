...
import { cadastroAction, editarRoleAction } from "./actions";
...
export function UsuariosClient({
  ...
  const [createState, createAction, isCreating] = useActionState(cadastroAction, {});
  const [editState, editAction, isEditing] = useActionState(editarRoleAction, {});
